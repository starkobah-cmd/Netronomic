          ...
          >
            ...
            <div className="relative mx-auto max-w-md lg:max-w-none">
              ...
              <div className="relative bg-white rounded-2xl border border-sky-100 shadow-xl overflow-hidden p-6 space-y-6">
                ...
                {/* Bottom WhatsApp bar */}
                <a
                  href={(activeAgency.whatsappNumber?.startsWith('http') ? activeAgency.whatsappNumber : `https://wa.me/${activeAgency.whatsappNumber}?text=Hi%20${encodeURIComponent(activeAgency.name)},%20I%20am%20interested%20in%20your%20services.`)}
                  target="_blank"
